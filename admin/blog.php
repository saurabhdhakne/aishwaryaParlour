  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
              ...
              <li class="nav-item">
                <a class="nav-link collapsed" href="posters.php" aria-expanded="true" aria-controls="collapseTwo">
              ...
              <li class="nav-item">
                <a class="nav-link collapsed" href="brands.php" aria-expanded="true" aria-controls="collapseTwo">
              ...
              <li class="nav-item">
                <a class="nav-link collapsed" href="rating.php" aria-expanded="true" aria-controls="collapseTwo">
                      ...
                      <?php 
                            ...
                            ?>
                                ...
                                <tr>
                                      ...
                                      <td> <?php echo $date; ?>  </td>
                                      <td> <input type="button" class="btn btn-outline-primary" value="Open" onclick="window.location='https://.in/blog/post.php?id=<?php echo $id  ?>' "> </td>
