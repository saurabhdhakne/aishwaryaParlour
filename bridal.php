...
<body>
    ...
    <div class="offcanvas-menu-wrapper">
        ...
        <div class="canvas-social">
            <a href="https://www.instagram.com/archanamantri1234/"><i class="fa fa-instagram"></i></a>
                ...
                <div class="col-lg-6">
                    <nav class="nav-menu">
                        <ul>
                            <li><a href="./index.html">Home</a></li>
                            <li><a href="./transformation.php">Transformation</a></li>
                            <li class="active"><a href="./bridal.php">Bridal Makeup</a></li>
                            <li><a href="./sider.php">Sider Makeup</a></li>
                            <li><a href="./occasional.php">Occasional Makeup</a></li>
                            <li><a href="./services.html">Salon Services</a></li>
                            <li><a href="./academy.html">Academy</a></li>
    ...
    <section class="breadcrumb-section set-bg" data-setbg="img/hero/bg3.png">
        <div class="container">
            <div class="row">
