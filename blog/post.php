                  ...
                  <div class="card col-md-10 offset-md-1">
                      ...
                      <div class="card-body pb-5">
                        ...
                        <div class="col-md-12 d-flex justify-content-center mb-5 text-dark">
                                             <a class="socialbtn display-3 " href="whatsapp://send?text=<?php echo $title ?>%20https://teeara.in/blog/post.php?id=<?php echo $id  ?>"><i class="fa fa-whatsapp" aria-hidden="true"></i></a> 
                                &nbsp;&nbsp; <a class="socialbtn display-3 " href="https://www.facebook.com/sharer/sharer.php?u=https://teeara.in/blog/post.php?id=<?php echo $id  ?>"><i class="fa fa-facebook-official" aria-hidden="true"></i></a> 
